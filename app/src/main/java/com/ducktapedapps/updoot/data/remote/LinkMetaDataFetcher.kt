...
private fun Flow<Document>.toMetaDataMap(): Flow<Map<String, String>> = map {
...
private fun Flow<Map<String, String>>.toLinkModel(url: String): Flow<LinkModel> = map { metaDataMap ->
